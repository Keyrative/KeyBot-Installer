...
@echo off
title KeyBot
cd "%USERPROFILE%\Documents\Applications\KeyBot\TwitchMarkovChain"
"%LOCALAPPDATA%\Programs\Python\Python312\python.exe" "%USERPROFILE%\Documents\Applications\KeyBot\TwitchMarkovChain\MarkovChainBot.py"
exit
"@
...
$tempBatchFilePath = Join-Path -Path $tempDir -ChildPath "KeyBotTemp.bat"
...
# Stop the processes
Stop-Process -Name 'KeyBot' -Force
