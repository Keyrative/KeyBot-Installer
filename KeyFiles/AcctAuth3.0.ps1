...
$Message = "In the next window, you'll be prompted to enter more info about your Twitch bot account as well as configure some options for the KeyBot"
...
function PromptAndSave($prompt, $infoText, $defaultText = "") {
    # Create a form for user input
    $form = New-Object System.Windows.Forms.Form
    $form.Text = "KeyBot Configuration"
...
$generateCommands = '"GenerateCommands": ["!generate", "!g",]'
$generateCommands | Out-File -FilePath $filePath -Append

# Prompt for additional Generate Commands with default value
PromptAndSave "Generate Command (comma-separated):" "GenerateCommands:" "!generate, !g,"
...
#Invoke-WebRequest -Uri "https://github.com/fosterbarnes/KeyFiles/archive/refs/heads/main.zip" -OutFile "$env:USERPROFILE\Downloads\KeyFiles.zip"
...
#Copy-Item -Path "$env:USERPROFILE\Downloads\TwitchMarkovChain\TwitchMarkovChain-main" -Destination "$env:USERPROFILE\Downloads\KeyFiles\KeyFiles-main" -Recurse
#Rename-Item -Path "$env:USERPROFILE\Downloads\KeyFiles\KeyFiles-main\TwitchMarkovChain-main" -NewName "TwitchMarkovChain"
...
$keySettings = Join-Path -Path $env:USERPROFILE -ChildPath "Downloads\KeyFiles\TwitchMarkovChain\Settings.py"
...
$settingsContent = Get-Content -Path $keySettings
...
$settingsContent | Set-Content -Path $keySettings

$keySettings2 = Join-Path -Path $env:USERPROFILE -ChildPath "Downloads\KeyFiles\TwitchMarkovChain\Settings.py"

# Read the content of the file
$keySettingsContent = Get-Content $keySettings2

# Modify line 36
$keySettingsContent[35] = $keySettingsContent[35] -replace '"Channel": ""Channel": "', '"Channel": "'
# Remove the last 2 characters from line 36
$keySettingsContent[35] = $keySettingsContent[35] -replace '..$'

# Modify line 37
$keySettingsContent[36] = $keySettingsContent[36] -replace '"Nickname": ""Nickname": ', '"Nickname": '
# Remove the last 2 characters from line 37
$keySettingsContent[36] = $keySettingsContent[36] -replace '..$'

# Modify line 38
$keySettingsContent[37] = $keySettingsContent[37] -replace '"Authentication": "oauth:oauth:', '"Authentication": "oauth:'

# Replace line 39
$keySettingsContent[38] = $keySettingsContent[38] -replace '"DeniedUsers": "DeniedUsers": ', '"DeniedUsers": '
# Remove the last character from line 39
$keySettingsContent[38] = $keySettingsContent[38] -replace '.$'

# Replace line 41
$keySettingsContent[40] = $keySettingsContent[40] -replace '"Cooldown": "Cooldown":', '"Cooldown":'
# Remove the last character from line 41
$keySettingsContent[40] = $keySettingsContent[40] -replace '.$'

# Replace line 51
$keySettingsContent[50] = $keySettingsContent[50] -replace '"GenerateCommands": "GenerateCommands":', '"GenerateCommands":'

# Write the modified content back to the file
$keySettingsContent | Set-Content $keySettings2
